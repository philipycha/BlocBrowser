...
- (void)showAlert {
    UIAlertView *alert = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"Howdy!", @"Welcome title")
                                                    message:NSLocalizedString(@"Have a great one!", @"Welcome comment")
                                                   delegate:nil
                                          cancelButtonTitle:NSLocalizedString(@"I'm ready to search!", @"Welcome button title") otherButtonTitles:nil];
    [alert show];
